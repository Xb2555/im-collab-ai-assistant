...
public class DocumentExecutionGuard {
    ...
    public DocumentExecutionGuard(ObjectProvider<RedissonClient> redissonClientProvider) {
    ...
    public void execute(String lockKey, Runnable action) {
        ...
        if (redissonClient != null) {
            executeWithDistributedLock(redissonClient.getLock("harness:document:" + lockKey), action);
            return;
        }
