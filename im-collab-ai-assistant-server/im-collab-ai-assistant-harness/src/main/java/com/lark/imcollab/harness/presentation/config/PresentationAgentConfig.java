    ...
    public ReactAgent presentationStorylineAgent(ChatModel chatModel) {
        return ReactAgent.builder()
                ...
                .systemPrompt("""
                        ...
                        规则：
                        1. 默认生成 5-7 页，最多 10 页；用户明确要求“一页/单页”时 pageCount 必须是 1。
    ...
    public ReactAgent presentationOutlineAgent(ChatModel chatModel) {
        return ReactAgent.builder()
                ...
                .systemPrompt("""
                        ...
                        2. 每页 keyPoints 只能有 3-5 条，每条不超过 42 个中文字符；技术枚举、接口名、状态名必须完整保留。
                        3. layout 只能描述稳定布局，例如 cover、section、two-column、summary、timeline、risk-list。
