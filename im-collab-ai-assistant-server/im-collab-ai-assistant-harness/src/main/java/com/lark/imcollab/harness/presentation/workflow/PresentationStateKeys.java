package com.lark.imcollab.harness.presentation.workflow;
...
public final class PresentationStateKeys {
    ...
    public static final String TASK_BRIEF = "taskBrief";
    public static final String EXECUTION_CONTRACT = "executionContract";
