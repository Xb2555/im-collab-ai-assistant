...
class InsertImageBlockStepHandlerTest {
    ...
    void handleEmbedsCaptionIntoInsertedMarkdownImage() {
        ...
        when(larkDocTool.updateByCommand(eq("doc123"), eq("block_insert_after"), eq("![东方明珠](file-token-1)"),
                ...
                .thenReturn(LarkDocUpdateResult.builder()
                        ...
                        .build());
        InsertImageBlockStepHandler handler = new InsertImageBlockStepHandler(larkDocTool);
        ...
        verify(larkDocTool).updateByCommand("doc123", "block_insert_after", "![东方明珠](file-token-1)",
