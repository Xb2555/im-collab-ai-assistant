...
class DefaultPlannerPlanFacadeTest {
    ...
    void startTaskImmediateReplyDoesNotPreviewPendingFollowUpRecommendation() {
        ...
        verify(matcher, never()).match(anyString(), any(), anyBoolean());
    }
    ...
    void adjustPlanImmediateReplyCanPreviewPendingFollowUpRecommendation() {
        ...
        when(matcher.match("基于这份文档生成一版汇报PPT", List.of(recommendation), false))
        ...
        verify(matcher).match("基于这份文档生成一版汇报PPT", List.of(recommendation), false);
    }
}
