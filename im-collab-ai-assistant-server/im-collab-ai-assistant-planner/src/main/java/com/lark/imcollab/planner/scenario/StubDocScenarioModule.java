...
@Component
public class StubDocScenarioModule implements ScenarioModule {

    @Override
    public ScenarioCodeEnum scenarioCode() {
        return ScenarioCodeEnum.C_DOC;
    }
    ...
    public boolean supports(PlanBlueprint blueprint) {
        ...
        return blueprint.getPlanCards().stream()
                ...
                .anyMatch(type -> type == PlanCardTypeEnum.DOC || type == PlanCardTypeEnum.SUMMARY);
    }
